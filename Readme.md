...
* Студент: [Богдан Попов](https://up.htmlacademy.ru/adaptive/27/user/2229883).
* Наставник: `Александр Панасюк`.
искуственная строчка для сохранения через терминал
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-adaptive/2229883-sedona-27) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии будет скопирован в ваш аккаунт.
...
[check-image]: https://github.com/htmlacademy-adaptive/2229883-sedona-27/workflows/Project%20check/badge.svg?branch=master
[check-url]: https://github.com/htmlacademy-adaptive/2229883-sedona-27/actions
